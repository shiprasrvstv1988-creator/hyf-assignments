...
// - wishlist: an array of objects, each with a name and a thumbnail property.
// - addToWishlist: a function that adds an item to the wishlist.
// - removeFromWishlist: a function that removes an item from the wishlist.
// - isInWishlist: a function that checks if an item is in the wishlist.
